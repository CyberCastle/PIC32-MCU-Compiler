...
#else
const char bug_report_url[] = "<URL:https://github.com/CyberCastle/PIC32-MCU-Compiler>";
#endif
...
#define _BUILD_MCHP_
#ifdef _BUILD_C32_
const char version_string[] = BASEVER " " "CyberCastle Edition Compiler for PIC32M MCUs v2.40"; /* XC32 */
